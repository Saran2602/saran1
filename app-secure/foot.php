<footer class="footer">
                ...
                Blog
                                        ...
                                        <div class="copyright">
                                            ...
                                            <a href="javascript:void(0)" target="_blank">NUTZ INDIA</a> for a better web.
                                        </div>
                                    </div>
                                </footer>
                            </div>
                        ...
                        <div class="fixed-plugin">
                            <div class="dropdown show-dropdown">
                                <a href="#" data-toggle="dropdown">
                                    <i class="iconify" data-icon="ant-design:setting-filled" data-inline="false"></i>
                                    <style>
                                        .iconify {
                                            width: 35px;
                                            height: 35px;
    ...
    <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=111649226022273&amp;ev=PageView&amp;noscript=1" />
                        ...
                        <script>
                            ...
                            var output1 = document.getElementById("Tania Mike");
                        ...
                        <script>
                            ...
                            var output2 = document.getElementById("John Doe");
                        ...
                        <script>
                            ...
                            var output3 = document.getElementById("Alexa Mike");
                        ...
                        <script>
                            ...
                            var output4 = document.getElementById("Jana Monday");
                        ...
                        <script>
                            ...
                            var output5 = document.getElementById("Paul Dickens");
                        ...
                        <script>
                            ...
                            var output6 = document.getElementById("Manuela Rico");
